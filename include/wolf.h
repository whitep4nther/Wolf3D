...
/*   Updated: 2015/05/24 22:05:10 by ihermell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					render(t_env *e);
void					render_sector(t_segment2 *ray, t_game *game, t_mlx *mlx, t_render *render);
int						cast_to_sector(t_segment2 *ray, t_sector *sector, t_game *game,
						t_render *render);
